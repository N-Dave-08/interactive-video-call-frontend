...
const RainOverlay = () => {
  ...
  return (
    <div className="absolute inset-0 pointer-events-none z-40 overflow-hidden">
      {rainDrops.map((drop) => (
        <RainDrop key={drop.id} delay={drop.delay} duration={drop.duration} left={drop.left} />
      ))}
    </div>
  )
}
...
export default function MapEventPicker({ onChange }: MapEventPickerProps) {
  ...
  useEffect(() => {
    ...
    const selectedWeather = weatherOptions.find((option) => option.value === weather)
  ...
  return (
    <TooltipProvider>
      <div className="max-w-7xl mx-auto p-6 bg-gradient-to-br from-pink-50 via-purple-50 to-blue-50 min-h-screen relative overflow-hidden">
        {/* Floating elements */}
        <div className="absolute top-4 left-8 text-4xl animate-bounce" style={{ animationDelay: "0.2s" }}>
          ✨
        </div>
        <div className="absolute top-12 right-10 text-4xl animate-bounce" style={{ animationDelay: "0.7s" }}>
          ☁️
        </div>
        ...
        <div className="text-center mb-8 relative z-10">
          <motion.h1
            ...
            animate={{
              textShadow: ["2px 2px 0px #ec4899", "2px 2px 0px #8b5cf6", "2px 2px 0px #06b6d4", "2px 2px 0px #ec4899"],
            }}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6 relative z-10">
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-gradient-to-br from-purple-100 to-pink-100 rounded-2xl p-4 border-2 border-purple-200 shadow-lg">
              <h4 className="font-black text-purple-800 mb-2 text-center">🎮 How to Play</h4>
                    ...
                    <TooltipTrigger asChild>
                      <motion.div
                        style={{
                          ...
                          transition: "background-color 0.2s ease-in-out, border-radius 0.3s ease-in-out",
                        }}
