import { AccountCreationForm } from "@/components/forms/account-creation-form";
	...
	return (
		<Container index={0}>
			<div className="flex flex-col items-center justify-center size-full py-20">
				<p className="text-2xl font-bold mb-12">Account Creation Form</p>
				<div className="flex items-center justify-between bg-gradient-to-r from-blue-100 via-blue-50 to-purple-100 w-5xl h-full rounded-xl px-20 py-16 gap-12 border shadow-lg">
