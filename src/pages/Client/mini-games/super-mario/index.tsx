...
export default function SuperMario() {
	...
	// Mario game URLs with fallbacks
	const MARIO_GAME_URLS = [
		"https://supermario-game.com/", // Alternative Mario game
		"https://mario-game.org/", // Another alternative
		"https://html5games.com/Game/Super-Mario-Bros/", // HTML5 games site
		"https://openhtml5games.github.io/games-mirror/dist/mariohtml5/", // Original (may not work)
	];
	...
	const tryNextUrl = () => {
		if (currentUrlIndex < MARIO_GAME_URLS.length - 1) {
			setCurrentUrlIndex(prev => prev + 1);
			setError(null);
			setIsLoading(true);
		} else {
			setError("All Mario game sources are unavailable");
		}
	};
				...
				<Card className="overflow-hidden shadow-2xl border-0">
					...
					<CardContent className="p-0">
						<div className="relative bg-black">
								...
								<div className="absolute inset-0 bg-black/80 flex items-center justify-center z-20">
									<div className="text-white text-center p-6">
										...
										<div className="flex gap-2 justify-center">
											...
											{currentUrlIndex < MARIO_GAME_URLS.length - 1 && (
												<Button onClick={tryNextUrl} variant="outline" className="text-white border-white hover:bg-white hover:text-black">
													Try Next Source
												</Button>
											)}
										</div>
							...
							<iframe
								ref={iframeRef}
								src={MARIO_GAME_URLS[currentUrlIndex]}
