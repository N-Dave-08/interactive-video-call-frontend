				...
				<CardContent className="p-8">
							...
							>
								...
								<div className="relative">
									...
									<div className="relative flex items-center">
										<div
											className={`absolute left-4 z-10 w-10 h-10 bg-gradient-to-r ${field.color} rounded-full flex items-center justify-center`}
										>
					...
					>
						<Button
							...
							className="px-8 py-4 text-lg font-bold bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white rounded-2xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
						>
							{loading ? (
								<motion.div
									animate={{ rotate: 360 }}
